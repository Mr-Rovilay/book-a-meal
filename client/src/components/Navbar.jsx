    ...
    <>
      <nav className="w-full h-24 flex flex-col justify-center items-center fixed z-20 bg-white border-b-2 border-b-green">
        <div className="container mx-auto lg:px-6">
          ...
          {dropDown ? (
            <motion.div
              className="lg:hidden w-full h-[100vh] fixed top-24 bg-black ease-in-out duration-100 right-0"
              onClick={showDropDown}
              initial={{ opacity: 0 }}
              ...
              <div className="w-full h-[320px] flex flex-col items-baseline pt-14 gap-6">
                <ul className="text-center p-0 flex flex-col justify-center w-full gap-y-8">
                  <li>
                    <a
                      href="#"
                      className="leading-normal no-underline text-white font-bold text-3xl hover:bg-dark-green"
                    >
                      Home
                    </a>
                  </li>
