...
const Banner = ({ text }) => {
  return (
    <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-8 section-container mx-auto xl:px-24 px-4 py-8 ">
      {/* img */}
      <div className="md:w-1/2">
        <img src={bannerImg} alt="" className="py-6" />
      ...
      <div className="md:w-1/2 space-y-7">
        ...
        <p className="text-[#4A4A4A] text-xl">
          ...
          before - order from the comfort of your home, office, or wherever you
